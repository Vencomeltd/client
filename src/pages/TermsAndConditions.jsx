...
const SECTIONS = [
  ...
  { id: 2, title: "Bookings and Payments", content: "All bookings are legally binding agreements between Guests and Hosts. VenCome processes and temporarily holds payments on behalf of Hosts and releases funds 48 hours after booking completion. VenCome charges a commission of 10% on each completed booking, deducted from the booking fee paid by the Guest. The remainder is released to the Host 48 hours after the booking ends. Guests will see the total booking fee inclusive of VenCome's commission at the point of booking. Founding hosts who joined VenCome prior to the platform's public launch date are entitled to zero commission on their first five completed bookings. This benefit applies to the specific account registered as a founding host and is non-transferable." },
  ...
  { id: 4, title: "Security Deposit", content: "A Host may require a security deposit for their space, in the amount shown on the listing. Deposits are normally taken as a card hold: the amount is reserved on the Guest's card shortly before check-in (48 hours before for Visa, 72 hours before for Mastercard and American Express, or straight after booking if check-in is sooner) and is not charged unless a claim is upheld. If a hold cannot be placed, the Guest will be asked to update their card and has 24 hours to do so, after which the booking may be cancelled. For longer stays or bookings over £200, a deposit may instead be charged at the time of booking. The Host has 24 hours after the booking ends to submit a damage claim. If no claim is made, the deposit is released to the Guest automatically. VenCome reserves the right to withhold part or all of the deposit, and pay it to the Host, in cases of damage, misuse, or breach of terms, following review of any claim." },
  { id: 5, title: "User Responsibilities", content: "Hosts agree to provide accurate, lawful, and up-to-date listings, ensure spaces are safe, suitable, and compliant with their intended use, comply with all applicable laws, regulations, and licensing requirements, ensure that any professional or regulated activities conducted in the space are carried out by appropriately qualified and insured individuals, and maintain public liability insurance of at least £5,000,000 in relation to their listed space.\n\nGuests agree to use the space responsibly, follow Host rules, and pay for any damages caused." },
  ...
  { id: 7, title: "Digital Room Licence", content: "Upon confirmation of a booking, VenCome will generate a digital room licence agreement between the Host and Guest (the \"Occupation Licence\"). This licence constitutes the legally binding agreement governing the use of the space for that booking. Where a Host has uploaded their own room licence template, that template will be used in place of VenCome's standard licence. VenCome is not a party to the room licence agreement.\n\nThe Occupation Licence grants the Guest a personal right to occupy the space for the agreed booking period only. It does not create a tenancy, lease, or any right of exclusive possession, and does not entitle the Guest to occupy the space outside the booked times. Spaces booked through VenCome must not be used, or represented as being used, as a residence.\n\nGuests must vacate the space by the end of the booked period. If a Guest fails to vacate on time, VenCome is authorised to charge the Guest's registered payment method a holdover charge of 200% of the applicable daily (or part-day) rate for each day or part-day the Guest remains beyond the booked period, in addition to any other rights available to the Host. Where a Host needs to reassign the space, the Host will give the Guest no less than 24 hours' notice.\n\nWhere the Occupation Licence is terminated by the Host on a notice-only basis (i.e. without the Guest being in breach), the Host must give the Guest no less than 7 days' written notice." },
  ...
  { id: 24, title: "Extended and Long-Term Bookings", content: "Bookings, or a Guest's cumulative use of a Host's space, exceeding 4 months require VenCome's prior written approval. VenCome may decline, condition, or terminate arrangements that have not been approved on this basis." },
  { id: 25, title: "Circumventing the Platform", content: "Where a Host and Guest are introduced through VenCome, they must not arrange bookings for that same space directly, outside the platform, in order to avoid VenCome's fees, for 12 months following the introduction. Users who do so remain liable to VenCome for the commission that would otherwise have been payable, and VenCome may suspend or terminate their account." },
];
