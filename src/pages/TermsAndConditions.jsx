...
const SECTIONS = [
  ...
  { id: 4, title: "Security Deposit", content: "VenCome may require a security deposit from Guests prior to booking. Where a deposit is held, it will be released within 7 days of the Host confirming the space has been left in satisfactory condition. VenCome reserves the right to withhold part or all of the deposit in cases of damage, misuse, or breach of terms." },
